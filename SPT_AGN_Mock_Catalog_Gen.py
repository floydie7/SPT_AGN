...
def generate_mock_cluster(cluster):
    ...
    line_of_sight_completeness_corr = np.hstack((cluster_agn_completeness, background_agn_completeness))
    ...
    AGN_list = Table([line_of_sight_agn_pix[0], line_of_sight_agn_pix[1],
                      line_of_sight_completeness_corr,
                      line_of_sight_selection_mem,
                      line_of_sight_j_abs_mag,
                      line_of_sight_cluster_agn_flag],
...
outAGN.write(f'{hcc_prefix}Data_Repository/Project_Data/SPT-IRAGN/MCMC/Mock_Catalog/Catalogs/Final_tests/'
             ...
             f'_semiempirical_withLF.fits', overwrite=True)
