...
mock_catalog = Table.read(tusker_prefix+'Data/MCMC/Mock_Catalog/Catalogs/pre-final_tests/refresh/'
                                        'mock_AGN_catalog_t12.00_e1.20_z-1.00_b0.50_C0.371_maxr5.00_seed890_flat_mask_refresh.cat',
                          format='ascii')
...
with MPIPool() as pool:
    ...
    backend = emcee.backends.HDFBackend(chain_file, name='bkg_fixed_variable_endpt_flat_mask')
