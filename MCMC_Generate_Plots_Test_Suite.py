...
chain_names = [chain_name for chain_name in chain_names if 'no-mu' in chain_name]
...
for chain_name, sampler in sampler_dict.items():
    ...
    fig.savefig(f'Data_Repository/Project_Data/SPT-IRAGN/MCMC/Mock_Catalog/Plots/Final_tests/phot_features/'
