...
for chain_name, sampler in sampler_dict.items():
    ...
    fig.savefig('Data/MCMC/Mock_Catalog/Plots/Final_tests/Slope_tests/trial_3/mcmc_results/'
    ...
    if chain_name not in ['trial2_t4.711_e0.00_z-1.00', 'trial3_t7.816_e0.00_z-1.50']:
        continue
