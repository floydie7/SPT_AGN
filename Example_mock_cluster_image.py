...
richest_cluster = mock_catalog_grp.groups[np.argpartition(richness, -1)[-2]]  # This uses a nicer looking mask
...
fig.savefig('Data_Repository/Project_Data/SPT-IRAGN/MCMC/Mock_Catalog/Plots/Final_tests/fuzzy_selection/'
            f'fuzzy_selection_{richest_cluster["SPT_ID"][0]}_example.png')
...
plt.show()
fig.savefig('Data_Repository/Project_Data/SPT-IRAGN/MCMC/Mock_Catalog/Plots/Final_tests/fuzzy_selection/'
            f'fuzzy_selection_{richest_cluster["SPT_ID"][0]}_example_membership.png')
