...
def sdwfs_wise_gal_irac_agn(sdwfs_wise_gal, sdwfs_irac_agn_bright):
    ...
    mag_bin_width = 0.25
    num_counts_mag_bins = np.arange(wise_bright_mag, wise_faint_mag, mag_bin_width)
    ...
    selection_membership_columns = [colname for colname in sdwfs_irac_agn_bright.colnams
...
spt_wise_gal = spt_wise_gal[spt_wise_gal_sep_mpc > inner_radius_mpc]
spt_wise_gal = spt_wise_gal[spt_wise_gal_sep_mpc <= outer_radius_mpc]
