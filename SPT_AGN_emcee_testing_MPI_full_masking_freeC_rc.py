...
def model_rate_opted(params, cluster_id, r_r500):
    ...
    theta, eta, zeta, beta, C, rc = params
...
def lnprior(param):
    ...
    theta, eta, zeta, beta, C, rc = param
    ...
    total_lnprior = theta_lnprior + eta_lnprior + zeta_lnprior + beta_lnprior + C_lnprior + rc_lnprior
...
C_true = 0.371       # Background AGN surface density (in 1/arcmin2)
...
pos0 = emcee.utils.sample_ball(p0=[theta_true, eta_true, zeta_true, beta_true, C_true, rc_true],
                               std=[1e-2, 1e-2, 1e-2, 1e-2, 0.157, 1e-2], size=nwalkers)
...
labels = [r'$\theta$', r'$\eta$', r'$\zeta$', r'$\beta$', r'$C$', r'$r_c$']
truths = [theta_true, eta_true, zeta_true, beta_true, C_true, rc_true]
