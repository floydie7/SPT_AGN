...
mock_fnames = glob.glob('Data/MCMC/Mock_Catalog/Catalogs/Final_tests/core_radius_tests/trial_8/*.cat')
...
fig.savefig(
    'Data/MCMC/Mock_Catalog/Plots/Final_tests/core_radius_tests/mock_catalogs_theta_trend_rc_modeled_trial_8.pdf',
    format='pdf')
plt.show()
